...
@class ASLRBLiveRoomViewController,ASLRBLiveInitConfig;
...
//######################## 此部分各种Holder是用来承载业务方自定义的各种UI控件的背景view ----开始 #####################
...
//######################## 此部分各种Holder是用来承载业务方自定义的各种UI控件的背景view ----结束 #####################


//######################## 此部分是内部已经定义好的UI控件 ----开始 #####################
/**
 * 展示直播系统消息的label，外部可以更改设置其文案；注意外部更改liveSystemMessageLabel的frame时需要使用Masonry的mas_remakeConstraints接口；
 */
